...
public class KebabTest {
    ...
    public void setUp() {
        ...
        kebabBoeuf = new Assiette();
        kebabBoeuf = new Pain("pita",kebabBoeuf);
        kebabBoeuf = new Oignon("oignon rouge",kebabBoeuf);
        kebabBoeuf = new Sauce("sauce hamburger",kebabBoeuf);
    ...
    public void un_kebab_contient_bien_les_noms_de_tous_les_ingredients_ajoutes() {
		...
		.containsExactly("pita","oignon rouge","sauce hamburger","boeuf du Limousin","tomate rouge");
